...
if (isset($_POST['btn-category-save'])) {
    ...
    if ($result) {
        ...
        echo  $query = sprintf("INSERT INTO ao_category(category_id, category_name)
        VALUES ('%s','%s')", mysqli_real_escape_string($connect, $cid), mysqli_real_escape_string($connect, $cname));
        $connect->query($query);
        // SUCCESS
        header('Location: /admin-item-details');
    }
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="min-height:100vh">
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" @click="createItem()" data-bs-toggle="modal"
                            data-bs-target="#editFilmModal">Create</button>
                    </div>
                    <table class="table table-responsive table-hover table-striped">
                        ...
                        <tbody>
                            <tr v-for="film in films">
                                ...
                                <td>
                                    <button class="btn btn-primary btn-sm" @click="selectItem(film,'FILM')"
                                        data-bs-toggle="modal" data-bs-target="#editFilmModal">Edit</button>
                                    <button class="btn btn-danger btn-sm" @click="selectItem(film,'FILM')"
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        <h1>Category</h1>
                        <button class="btn btn-primary" @click="createItem()" data-bs-toggle="modal"
                            data-bs-target="#editCategoryModal">Create</button>
                    </div>
                    <table class="table table-responsive table-hover table-striped">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr v-for="category in categories">
                                ...
                                <td>
                                    <button class="btn btn-primary btn-sm" @click="selectItem(category,'CATEGORY')"
                                        data-bs-toggle="modal" data-bs-target="#editCategoryModal">Edit</button>
                                    <button class="btn btn-danger btn-sm" @click="selectItem(category,'CATEGORY')"
                                        data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        <h1>Brand</h1>
                        <button class="btn btn-primary" @click="createItem()" data-bs-toggle="modal"
                            data-bs-target="#editBrandModal">Create</button>
                    </div>
                    <table class="table table-responsive table-hover table-striped">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr v-for="brand in brands">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-sm" @click="selectItem(brand,'BRAND')"
                                        data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" id="category"
                                v-model="selectedItem.film_description" />
                        </div>
                        <div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <label for="description" class="form-label">Description</label>
                            <input type="text" class="form-control" id="category"
                                v-model="selectedItem.brand_description" />
                        </div>
                        <div>
                            <label for="image" class="form-label">Image</label>

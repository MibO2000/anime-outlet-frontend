                        ...
                        <tbody>
                            <tr v-for="item in items">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success btn-sm" @click="selectItem(item)"
                                        data-bs-toggle="modal" data-bs-target="#purchaseModal">Purchase</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="item_description"
                                    v-model="selectedItem.item_description">
                            </div>
                            <div class="col-6">
                                <label for="item_image_1" class="form-label">Image 1</label>
                                <input type="url" class="form-control" id="item_image_1"
                                    v-model="selectedItem.item_image_1">
                            </div>
                            <div class="col-6">
                                <label for="item_image_2" class="form-label">Image 2</label>
                                <input type="url" class="form-control" id="item_image_2"
                                    v-model="selectedItem.item_image_2">
                            </div>
                            <div class="col-6">
                                <label for="item_image_3" class="form-label">Image 3</label>
                                <input type="url" class="form-control" id="item_image_3"
                                    v-model="selectedItem.item_image_3">
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="stock_quantity"
                                    v-model="selectedItem.stock_quantity">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary"
                                @click="submitCreateOrEditModal()">Save</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                                @click="confirmPurchase()">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>

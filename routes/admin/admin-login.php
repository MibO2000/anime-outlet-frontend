...
if ($method === 'POST') {
    ...
    $query = sprintf('SELECT `fullname`,`username`,`admin_password`, `admin_id` FROM ao_admin WHERE username=\'%s\'', mysqli_real_escape_string($connect, $username));

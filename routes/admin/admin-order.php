                    ...
                    <table class="table table-responsive table-hover table-striped">
                        ...
                        <tbody>
                            <tr v-for="item in items">
                                <td><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#orderDetailModal" @click="loadOrderDetails(item.order_id)">{{item.order_id}}</td>
                                </a>
                                <td>
                                    {{item.full_name}}
                                </td>
                    ...
                    <table class="table table-responsive table-hover table-striped">
                        ...
                        <tbody>
                            <tr v-for="orderDetail in orderDetails">
                                <td>
                                    <img :src="orderDetail.item_image_1" style="width:100px;height:auto;" alt="item image">
                                </td>
                ...
                loadOrderDetails(orderId) {
                    ...
                    axios.get(`/admin-order?orderId=${orderId}`)
                        .then(response => {
                            ...
                            // Initialize Vue.js after a short delay
                            setTimeout(() => {
                                this.$nextTick(() => {
                                    // This will ensure that Vue.js has processed the template
                                });
                            }, 100);
                        })
                        .catch(error => {

                ...
                <div>
                    ...
                    <table class="table table-responsive table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            $query = "select ap.purchase_id, as2.supplier_name, aa.fullname, ap.purchase_date, ap.purchase_status, ap.total_amount from `ASSIGNMENT`.ao_purchase ap join `ASSIGNMENT`.ao_supplier as2 on as2.supplier_id = ap.supplier_id join `ASSIGNMENT`.ao_admin aa on aa.admin_id = ap.admin_id";
